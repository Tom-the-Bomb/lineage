            ...
            <main className="grow">
                <article className="grow flex flex-col gap-8 items-center justify-center px-10 sm:px-20 lg:px-30 xl:px-60 py-20">
                    ...
                    <div className="flex flex-col gap-7 text-base/7">
                        ...
                        <section className="flex flex-col gap-4" aria-labelledby="rail-property-heading">
                            <h2 className="text-2xl font-bold" id="rail-property-heading">Rail + Property Model</h2>
                            <p>
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                                    <div className="flex flex-col gap-2">
                                        <p>Some of the most notable examples of properties
                                        developed by the MTR include:</p>
                                    ...
                                    <img src={railProperty} alt="Aerial view of MTR rail property development showing residential and commercial buildings integrated with railway stations" loading="lazy" className="rounded-md drop-shadow-lg"/>
                                </div>
                            </div>
                            <div>
                        ...
                        <section className="flex flex-col gap-4" aria-labelledby="spotlight-heading">
                            <h2 className="text-2xl font-bold" id="spotlight-heading">MTR Spotlight</h2>
                            <p>
                            ...
                            <div>
                                ...
                                <div className="flex flex-col gap-6">
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                                        ...
                                        <img src={crossPlatform} alt="Diagram illustrating MTR cross-platform interchange design allowing passengers to transfer between lines by walking across the platform" loading="lazy" className="rounded-md p-2 shadow-lg"/>
                                    </div>
                                    <p>
                        ...
                        <section aria-labelledby="overseas-heading">
                            <h2 className="text-2xl font-bold" id="overseas-heading">Overseas Projects</h2>
                            <p className="mt-4">
                        ...
                        <section aria-labelledby="conclusion-heading">
                            <h2 className="text-2xl font-bold" id="conclusion-heading">Conclusion</h2>
                            <p className="mt-4">
